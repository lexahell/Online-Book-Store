...
for (let i = 0; i < countSlides; i++) {
  const newProductCardSlideString = `
    ...
    SwiperNoveltyWrapper.insertAdjacentHTML("afterbegin",newProductCardSlideString); //добавили элемент в html
    ...
    // Определям находится ди товар в избранном и меняем кнопку лайка
