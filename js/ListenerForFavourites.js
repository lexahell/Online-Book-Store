...
favouriteButtons.forEach((button) => {
  button.addEventListener("click", () => {
    ...
    if (
      ...
      button.closest(".product-card-slider").dataset.chgFavouritesStatus =
        "true";
      localStorage.setItem(`book_${id}`, "aboba");
      console.log("Aboba!");
      //localStorage.setItem(button.closest('.product-card-slider').dataset.chgProductId, button.closest('.product-card-slider').outerHTML);
    } else {
